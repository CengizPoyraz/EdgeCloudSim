...
public class EnergyAwareScenarioFactory implements ScenarioFactory {
    ...
    public EnergyAwareScenarioFactory(int _numOfMobileDevice, double _simulationTime, 
            String _orchestratorPolicy, String _simScenario) {
    ...
    public EdgeOrchestrator getEdgeOrchestrator() {
        return new EnergyAwareEdgeOrchestrator(orchestratorPolicy, simScenario);
    }
    ...
    public NetworkModel getNetworkModel() {
        return new EnergyAwareNetworkModel(numOfMobileDevice, simScenario);
    }
